...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/VaultLaboratories/solita-swift.git", branch: "main"),
        .package(name: "Solana", url: "https://github.com/VaultLaboratories/Solana.Swift.git", branch: "master")
    ],
    targets: [
